...
namespace UnityAssetReplacer {
	internal static class Program {
		...
		private static readonly OptionSet OptionParser = new() {
			{
				"b|bundle=",
				"the original asset {BUNDLE} path",
				v => Options.InputAssetBundlePath = v
			},
			{
				"i|input=",
				"the {INPUT} directory of the assets to overwrite with.",
			...
			{
				"t|texture",
				"Interact with {TEXTURE}s in the asset bundle.",
				v => Options.Textures = v != null
			},
			{
				"h|?|help",
				"show this message for and then exit.",
